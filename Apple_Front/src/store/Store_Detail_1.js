...
import './Store.css';
import i15promax from '../img/iphone_iphone15promax_large.png';
            ...
            <div className="container">
                <div className="store_detail_part1">
                    <div>
                        ...
                        <p className="store_detail_subtitle">1,900,000 부터</p>
                ...
                <div className="store_detail_part2 d-flex justify-content-between">
                    <div className="store_detail_left">
                        <img src={i15promax} alt="" className="store_detail_left_img" />
                    </div>
                    <div className="store_detail_right">
                        <div className="store_detail_name">
                            <h1 className="store_detail_name_item">iPhone 15 Pro Max</h1>
                        </div>
                        <div>
